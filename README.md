...
1. A baseline version of the system without BDI agents, used as a benchmark for testing.
2. The full BDI-based model implementation in GAMA.
3. Required GeoJSON files, images, and other resources needed to run the simulation.
